defmodule BubbliWeb.Router do
  ...
  scope "/", BubbliWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{BubbliWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", BubbliWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{BubbliWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", BubbliWeb do
    ...
    live_session :current_user,
      on_mount: [{BubbliWeb.UserAuth, :mount_current_user}] do
